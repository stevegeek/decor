...
class Navigo::PageTest < ActiveSupport::TestCase
  ...
  test "renders with full height layout when enabled" do
    component = Navigo::Page.new(full_height: true)
    rendered = render_component(component)
  ...
  test "renders with correct HTML structure" do
    ...
    page_div = fragment.at_css(".navigo--page")
  ...
  test "uses daisyUI semantic classes" do
    component = Navigo::Page.new(title: "Test Title", description: "Test description")
    rendered = render_component(component)
  ...
  test "applies correct size classes" do
    component = Navigo::Page.new(title: "Test", size: :lg)
    rendered = render_component(component)
  ...
  test "applies background classes" do
    [:primary, :secondary, :hero, :neutral].each do |background|
      component = Navigo::Page.new(background: background)
      rendered = render_component(component)
  ...
  test "applies padding classes" do
    component = Navigo::Page.new(padding: :lg)
    rendered = render_component(component)
  ...
  test "applies spacing classes" do
    component = Navigo::Page.new(spacing: :xl)
    rendered = render_component(component)
  ...
  test "supports tags" do
    component = Navigo::Page.new(title: "Test")
