...
class Navigo::BreadcrumbsTest < ActiveSupport::TestCase
  test "renders successfully with hash array" do
    ...
    component = Navigo::Breadcrumbs.new(breadcrumbs: crumbs)
  ...
  test "renders with Literal::Data objects" do
    crumbs = [
      Navigo::Breadcrumbs::Breadcrumb.new(name: "Home", path: "/"),
      Navigo::Breadcrumbs::Breadcrumb.new(name: "Products", path: "/products"),
      Navigo::Breadcrumbs::Breadcrumb.new(name: "Current Page", path: "/current", current: true)
    ]
  ...
  test "handles empty breadcrumbs array" do
    component = Navigo::Breadcrumbs.new(breadcrumbs: [])
    rendered = render_component(component)
  ...
  test "supports custom home configuration" do
    component = Navigo::Breadcrumbs.new(
      breadcrumbs: [],
      home_path: "/dashboard",
      home_icon: "dashboard"
    )
  ...
  test "supports mobile navigation" do
    ...
    component = Navigo::Breadcrumbs.new(breadcrumbs: crumbs, mobile_select: true)
    rendered = render_component(component)
  ...
  test "hides mobile navigation when disabled" do
    ...
    component = Navigo::Breadcrumbs.new(breadcrumbs: crumbs, mobile_select: false)
    rendered = render_component(component)
  ...
  test "handles mixed format arrays" do
    crumbs = [
      {name: "Home", path: "/"},
      {label: "Products", href: "/products"},
      Navigo::Breadcrumbs::Breadcrumb.new(name: "Current", path: "/current", current: true)
    ]
