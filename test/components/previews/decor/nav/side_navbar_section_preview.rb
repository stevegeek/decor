...
class ::Decor::Nav::SideNavbarSectionPreview < ::Lookbook::Preview
  ...
  def multiple_sections
    render ::Decor::Element.new html_options: {class: "space-y-4"} do |nav|
      ...
      nav.render ::Decor::Nav::SideNavbarSection.new(title: "Support") do |section|
  ...
  def section_with_mixed_items
    render ::Decor::Element.new html_options: {class: "space-y-4"} do
  ...
  def section_title_variations
    render ::Decor::Element.new html_options: {class: "space-y-4"} do |el|
      el.render ::Decor::Nav::SideNavbarSection.new(title: "Short") do |section|
        section.with_item(title: "Item 1", path: "/item1")
      end

      el.render ::Decor::Nav::SideNavbarSection.new(title: "Medium Length Title") do |section|
        section.with_item(title: "Item 2", path: "/item2")
      end

      el.render ::Decor::Nav::SideNavbarSection.new(title: "Very Long Section Title That Tests Wrapping") do |section|
