...
# @label Select
class ::Decor::Daisy::Forms::SelectPreview < ::Lookbook::Preview
  # @group Examples
  ...
  def default
    render ::Decor::Daisy::Forms::Select.new(
      ...
      **::Decor::Daisy::Forms::Select.map_options_for_select([
  ...
  def grouped_options
    render ::Decor::Daisy::Forms::Select.new(
      ...
      **::Decor::Daisy::Forms::Select.map_grouped_options_for_select([
        {
          title: "Electronics",
          value: [
  ...
  def in_form
    ...
    render_with_template(
      ...
      locals: {
        model: model,
        options: ::Decor::Daisy::Forms::Select.map_options_for_select([
