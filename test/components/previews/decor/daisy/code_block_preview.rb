# @label CodeBlock
class ::Decor::Daisy::CodeBlockPreview < ::Lookbook::Preview
  # CodeBlock
  # ---------
  #
  ...
  def basic_code_block
    render ::Decor::Daisy::CodeBlock.new do
      <<~CODE
  ...
  def code_block_highlight
    render ::Decor::Daisy::CodeBlock.new(
      language: "javascript",
      highlight: true
    ) do
      <<~JS
  ...
  def terminal_command
    render ::Decor::Daisy::CodeBlock.new(style: :terminal) do
      <<~TERMINAL
        $ npm install
  ...
  # @label Ruby Code
  def ruby_code
    render ::Decor::Daisy::CodeBlock.new(language: "ruby", highlight: true) do
      <<~RUBY
  ...
  # @label Python Code
  def python_code
    render ::Decor::Daisy::CodeBlock.new(language: "python", highlight: true) do
      <<~PYTHON
        def fibonacci(n):
            if n <= 1:
                return n
  ...
  # @label JSX Component
  def jsx_component
    render ::Decor::Daisy::CodeBlock.new(language: "jsx", highlight: true) do
      <<~JSX
