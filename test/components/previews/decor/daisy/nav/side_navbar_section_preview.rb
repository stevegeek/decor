...
class ::Decor::Daisy::Nav::SideNavbarSectionPreview < ::Lookbook::Preview
  # Groups related navigation items together with an optional title, commonly used within sidebar navigation.
  # @!group Examples

  # @label Basic Section
  def default
    render ::Decor::Daisy::Nav::SideNavbarSection.new(title: "Main Navigation") do |section|
  ...
  def with_expandable_items
    render ::Decor::Daisy::Nav::SideNavbarSection.new(title: "Administration") do |section|
  ...
  # @label With Counters
  def with_counters
    render ::Decor::Daisy::Nav::SideNavbarSection.new(title: "Activity") do |section|
  ...
  def multiple_sections
    render ::Decor::Daisy::Element.new html_options: {class: "decor:space-y-4"} do |nav|
      ...
      nav.render ::Decor::Daisy::Nav::SideNavbarSection.new(title: "Management") do |section|
  ...
  def playground(title: "Main", items_count: 3)
    render ::Decor::Daisy::Nav::SideNavbarSection.new(title: title.present? ? title : nil) do |section|
  ...
  # @label Empty Section
  def empty_section
    render ::Decor::Daisy::Nav::SideNavbarSection.new(title: "Empty Section")
  end
  ...
  def mixed_items
    render ::Decor::Daisy::Nav::SideNavbarSection.new(title: "Workspace") do |section|
