...
class ::Decor::Daisy::Tables::DataTableRowPreview < ::Lookbook::Preview
  ...
  def default
    render_table do |tbody|
      tbody.render ::Decor::Daisy::Tables::DataTableRow.new do |row|
  ...
  def selectable
    render_table do |tbody|
      tbody.render ::Decor::Daisy::Tables::DataTableRow.new(selectable_as: "user_1", selected: true) do |row|
  ...
  def clickable
    render_table do |tbody|
      tbody.render ::Decor::Daisy::Tables::DataTableRow.new(path: "/users/123") do |row|
  ...
  def playground(
    ...
    render_table do |tbody|
      tbody.render ::Decor::Daisy::Tables::DataTableRow.new(
  ...
  def disabled
    render_table do |tbody|
      tbody.render ::Decor::Daisy::Tables::DataTableRow.new(disabled: true) do |row|
  ...
  def hidden
    render_table do |tbody|
      ...
      tbody.render ::Decor::Daisy::Tables::DataTableRow.new(hidden: true) do |row|
  ...
  def hover_effects
    render_table do |tbody|
      tbody.render ::Decor::Daisy::Tables::DataTableRow.new(hover_highlight: true) do |row|
        row.with_data_table_cell(value: "Hover Enabled")
        row.with_data_table_cell(value: "Highlights on hover")
      end

      tbody.render ::Decor::Daisy::Tables::DataTableRow.new(hover_highlight: false) do |row|
  ...
  def multiple_selections
    render_table do |tbody|
      ...
      tbody.render ::Decor::Daisy::Tables::DataTableRow.new(selectable_as: "user_2") do |row|
        row.with_data_table_cell(value: "Unselected User 2")
        row.with_data_table_cell(value: "user2@example.com")
      end

      tbody.render ::Decor::Daisy::Tables::DataTableRow.new(selectable_as: "user_3", selected: true) do |row|
