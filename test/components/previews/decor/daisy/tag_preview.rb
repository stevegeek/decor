# @label Tag
class ::Decor::Daisy::TagPreview < ::Lookbook::Preview
  # Tag
  # -------
  #
  ...
  # @label Primary Color
  def color_primary
    render ::Decor::Daisy::Tag.new(label: "Primary", color: :primary)
  end

  # @group Colors
  # @label Secondary Color
  def color_secondary
    render ::Decor::Daisy::Tag.new(label: "Secondary", color: :secondary)
  end

  # @group Colors
  # @label Accent Color
  def color_accent
    render ::Decor::Daisy::Tag.new(label: "Accent", color: :accent)
  end

  # @group Colors
  # @label Success Color
  def color_success
    render ::Decor::Daisy::Tag.new(label: "Success", color: :success)
  end

  # @group Colors
  # @label Error Color
  def color_error
    render ::Decor::Daisy::Tag.new(label: "Error", color: :error)
  end

  # @group Colors
  # @label Warning Color
  def color_warning
    render ::Decor::Daisy::Tag.new(label: "Warning", color: :warning)
  end

  # @group Colors
  # @label Info Color
  def color_info
    render ::Decor::Daisy::Tag.new(label: "Info", color: :info)
  end

  # @group Colors
  # @label Neutral Color
  def color_neutral
    render ::Decor::Daisy::Tag.new(label: "Neutral", color: :neutral)
  end

  # @group Sizes
  # @label Extra Small
  def size_xs
    render ::Decor::Daisy::Tag.new(icon: "heart", label: "XS Tag", size: :xs, removable: true)
  end

  # @group Sizes
  # @label Small
  def size_sm
    render ::Decor::Daisy::Tag.new(icon: "heart", label: "Small Tag", size: :sm, removable: true)
  end

  # @group Sizes
  # @label Medium (Default)
  def size_md
    render ::Decor::Daisy::Tag.new(icon: "heart", label: "Medium Tag", size: :md, removable: true)
  end

  # @group Sizes
  # @label Large
  def size_lg
    render ::Decor::Daisy::Tag.new(icon: "heart", label: "Large Tag", size: :lg, removable: true)
  end

  # @group Sizes
  # @label Extra Large
  def size_xl
    render ::Decor::Daisy::Tag.new(icon: "heart", label: "XL Tag", size: :xl, removable: true)
  end

  # @group Styles
  # @label Filled (Default)
  def style_filled
    render ::Decor::Daisy::Tag.new(label: "Filled Tag", color: :primary, style: :filled)
  end

  # @group Styles
  # @label Outlined
  def style_outlined
    render ::Decor::Daisy::Tag.new(label: "Outline Tag", color: :primary, style: :outlined)
  end

  # @group Styles
  # @label Ghost
  def style_ghost
    render ::Decor::Daisy::Tag.new(label: "Ghost Tag", color: :primary, style: :ghost)
  end

  # @group With Icons
  # @label Basic Icon
  def icon_basic
    render ::Decor::Daisy::Tag.new(label: "Tagged", icon: "tag", color: :info)
  end
  ...
  # @label Star Rating
  def icon_star
    render ::Decor::Daisy::Tag.new(label: "Favorite", icon: "star", color: :warning)
  end

  # @group With Icons
  # @label User Tag
  def icon_user
    render ::Decor::Daisy::Tag.new(label: "Admin", icon: "user", color: :accent)
  end
