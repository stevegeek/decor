# @label Tooltip
class ::Decor::Daisy::TooltipPreview < ::Lookbook::Preview
  # Tooltips
  # --------
  #
  ...
  # @label Basic Tooltip
  def basic_tooltip
    render ::Decor::Daisy::Tooltip.new(tip_text: "This is a helpful tooltip") do |el|
      el.render ::Decor::Daisy::Button.new(label: "Hover me")
    end
  end
  ...
  def tooltip_with_position
    render ::Decor::Daisy::Tooltip.new(tip_text: "I appear on the right", position: :right) do |el|
      el.render ::Decor::Daisy::Button.new(label: "Right tooltip", color: :primary)
    end
  end
  ...
  def styled_tooltip
    render ::Decor::Daisy::Tooltip.new(tip_text: "Important information!", color: :error, style: :outlined) do |el|
      el.render ::Decor::Daisy::Button.new(label: "Important", color: :error)
    end
  end
  ...
  def combo_large_primary_left
    render ::Decor::Daisy::Tooltip.new(
      ...
      t.render ::Decor::Daisy::Button.new(label: "Large Primary Left", color: :primary, size: :large)
    end
  end
  ...
  def combo_small_error_bottom
    render ::Decor::Daisy::Tooltip.new(
      ...
      t.render ::Decor::Daisy::Button.new(label: "Small Error Bottom", color: :error, size: :small)
    end
  end
  ...
  def combo_ghost_warning_right
    render ::Decor::Daisy::Tooltip.new(
      ...
      t.render ::Decor::Daisy::Button.new(label: "Ghost Warning Right", style: :ghost, color: :warning)
    end
  end
