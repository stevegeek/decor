...
class ::Decor::Suite::StatTest < ActiveSupport::TestCase
  ...
  test "does not render daisyUI stat slab classes" do
    html = render_component(::Decor::Suite::Stat.new(title: "T", value: "1", description: "+1%", delta: :up))
    refute_includes html, "decor:d-stat"
    refute_includes html, "decor:d-stat-title"
    refute_includes html, "decor:d-stat-value"
    refute_includes html, "decor:d-stat-desc"
    refute_includes html, "decor:d-stat-figure"
  end
