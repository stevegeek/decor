...
class ::Decor::Suite::Forms::HiddenFieldTest < ActiveSupport::TestCase
  ...
  test "no daisy / suite input chrome classes leak in" do
    html = render_component(::Decor::Suite::Forms::HiddenField.new(name: "n", value: "v"))
    refute_includes html, "decor:suite-input-base"
    refute_includes html, "decor:border-suite-hairline-strong"
