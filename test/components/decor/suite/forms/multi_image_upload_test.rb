...
class ::Decor::Suite::Forms::MultiImageUploadTest < ActiveSupport::TestCase
  ...
  test "no Confinus tokens leak (no text-error-dark / bg-primary-600 / rounded-control)" do
    html = render_component(::Decor::Suite::Forms::MultiImageUpload.new(name: "imgs", label: "Photos"))
    refute_includes html, "text-error-dark"
    refute_includes html, "bg-primary-600"
    refute_includes html, "rounded-control\""
    refute_includes html, "rounded-card"
  end
end
