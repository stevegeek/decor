...
class ::Decor::Suite::Forms::ButtonRadioGroupTest < ActiveSupport::TestCase
  ...
  test "no daisy class leakage (no d-join / d-btn / btn-active)" do
    html = render_component(
      ::Decor::Suite::Forms::ButtonRadioGroup.new(name: "n", choices: CHOICES, selected_choice: "a")
    )
    refute_includes html, "decor:d-join"
    refute_includes html, "decor:d-btn"
    refute_includes html, "decor:btn-active"
  end
end
