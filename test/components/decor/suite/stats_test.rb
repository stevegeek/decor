...
class ::Decor::Suite::StatsTest < ActiveSupport::TestCase
  ...
  test "does not emit daisyUI Stats chrome tokens" do
    html = render_component(::Decor::Suite::Stats.new)
    refute_includes html, "decor:d-stats"
    refute_includes html, "decor:d-stats-vertical"
    refute_includes html, "decor:d-stats-horizontal"
  end

  test "does not emit non-suite border or surface tokens" do
    html = render_component(::Decor::Suite::Stats.new(orientation: :vertical, responsive: false))
    refute_includes html, "decor:bg-base-100"
    refute_includes html, "decor:border-base-300"
    refute_includes html, "decor:shadow"
  end
