...
class Decor::Daisy::PaginationTest < ActiveSupport::TestCase
  ...
  test "renders successfully with valid attributes" do
    component = Decor::Daisy::Pagination.new(collection: @collection, path: "/items")
  ...
  test "returns page size options" do
    ...
    component = Decor::Daisy::Pagination.new(collection: collection, page_size: 6)
  ...
  test "renders page size selector when enabled" do
    component = Decor::Daisy::Pagination.new(collection: @collection, page_size_selector: true, path: "/items")
    rendered = render_component(component)
