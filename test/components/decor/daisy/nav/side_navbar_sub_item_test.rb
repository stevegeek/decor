...
class Decor::Daisy::Nav::SideNavbarSubItemTest < ActiveSupport::TestCase
  test "renders successfully with DaisyUI classes" do
    component = Decor::Daisy::Nav::SideNavbarSubItem.new(title: "Profile", path: "/profile")
    rendered = render_component(component)

    assert_includes rendered, "decor--daisy--nav--side-navbar-sub-item"
  ...
  test "renders as li element" do
    ...
    li_element = fragment.at_css("li.decor--daisy--nav--side-navbar-sub-item")
    assert_not_nil li_element
  end

  test "applies active styling when selected" do
    component = Decor::Daisy::Nav::SideNavbarSubItem.new(title: "Profile", path: "/profile", selected: true)
    rendered = render_component(component)
  ...
  test "renders icon with proper styling" do
    component = Decor::Daisy::Nav::SideNavbarSubItem.new(title: "Profile", path: "/profile", icon: "user")
    rendered = render_component(component)
  ...
  test "defaults path to hash when not provided" do
    component = Decor::Daisy::Nav::SideNavbarSubItem.new(title: "Profile")
    rendered = render_component(component)
