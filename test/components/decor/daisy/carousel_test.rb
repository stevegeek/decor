...
class Decor::Daisy::CarouselTest < ActiveSupport::TestCase
  ...
  test "renders with correct HTML structure" do
    ...
    # The outer element has decor--daisy--carousel class, inner div has carousel class
    assert_includes rendered, "decor--daisy--carousel"
  ...
  test "supports custom CSS classes" do
    component = Decor::Daisy::Carousel.new(html_options: {class: "custom-carousel"})
    rendered = render_component(component)
