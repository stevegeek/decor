...
class Decor::Daisy::FormattedEncodedIdTest < ActiveSupport::TestCase
  test "renders successfully with encoded_id" do
    component = Decor::Daisy::FormattedEncodedId.new(encoded_id: "ABC123DEF456")
  ...
  test "renders prefix with low emphasis styling when provided" do
    ...
    component = Decor::Daisy::FormattedEncodedId.new(encoded_id: "USR-ABC123DEF456", prefix: "USR")
  ...
  test "does not render prefix when blank" do
    component = Decor::Daisy::FormattedEncodedId.new(encoded_id: "ABC123DEF456", prefix: "")
    rendered = render_component(component)
  ...
  test "applies default CSS classes" do
    ...
    assert_includes rendered, "decor--daisy--formatted-encoded-id"
    assert_includes rendered, "inline-flex items-center"
  end
  ...
  test "uses nokogiri for parsing p element structure" do
    ...
    assert_includes p["class"], "decor--daisy--formatted-encoded-id"
  ...
  test "handles encoded ID without prefix in rendered output" do
    component = Decor::Daisy::FormattedEncodedId.new(encoded_id: "XYZ789")
    fragment = render_fragment(component)
  ...
  test "renders component with ID attribute" do
    component = Decor::Daisy::FormattedEncodedId.new(encoded_id: "TEST123", id: "my-formatted-id")
    rendered = render_component(component)
  ...
  test "handles various encoded ID formats" do
    ...
    simple_ids.each do |test_id|
      component = Decor::Daisy::FormattedEncodedId.new(encoded_id: test_id)
      rendered = render_component(component)
    ...
    component = Decor::Daisy::FormattedEncodedId.new(encoded_id: "USER_456")
    rendered = render_component(component)
  ...
  test "component inherits from PhlexComponent" do
    component = Decor::Daisy::FormattedEncodedId.new(encoded_id: "ABC123")
