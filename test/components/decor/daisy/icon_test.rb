...
class Decor::Daisy::IconTest < ActiveSupport::TestCase
  test "renders successfully with name" do
    component = Decor::Daisy::Icon.new(name: "home")
  ...
  test "applies correct variant classes" do
    component = Decor::Daisy::Icon.new(name: "user", style: :solid)
    rendered = render_component(component)
  ...
  test "applies correct collection" do
    component = Decor::Daisy::Icon.new(name: "star", collection: :heroicons)
    rendered = render_component(component)
  ...
  test "applies custom width and height" do
    component = Decor::Daisy::Icon.new(name: "cog", width: 32, height: 32)
    rendered = render_component(component)
  ...
  test "renders small solid variant" do
    component = Decor::Daisy::Icon.new(name: "check", style: :small_solid)
    rendered = render_component(component)
  ...
  test "renders inline icon" do
    component = Decor::Daisy::Icon.new(name: "info", inline: true)
    rendered = render_component(component)
  ...
  test "generates correct file name" do
    component = Decor::Daisy::Icon.new(name: "arrow-left", collection: :heroicons, style: :outline)
  ...
  test "handles nil style by falling back to default" do
    component = Decor::Daisy::Icon.new(name: "test-icon", style: nil)
  ...
  test "uses default style when style not provided" do
    component = Decor::Daisy::Icon.new(name: "default-icon")
