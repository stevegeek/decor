...
class Decor::Daisy::Tables::DataTableTest < ActiveSupport::TestCase
  test "renders successfully" do
    component = Decor::Daisy::Tables::DataTable.new
    rendered = render_component(component)

    assert_includes rendered, "table"
    assert_includes rendered, "decor--daisy--tables--data-table"
  end
  ...
  test "supports daisyUI size variants" do
    component = Decor::Daisy::Tables::DataTable.new(size: :xs)
    rendered = render_component(component)
    assert_includes rendered, "table-xs"

    component = Decor::Daisy::Tables::DataTable.new(size: :sm)
    rendered = render_component(component)
    assert_includes rendered, "table-sm"

    component = Decor::Daisy::Tables::DataTable.new(size: :lg)
    rendered = render_component(component)
    assert_includes rendered, "table-lg"

    component = Decor::Daisy::Tables::DataTable.new(size: :xl)
    rendered = render_component(component)
    assert_includes rendered, "table-xl"

    # md is default, no class needed
    component = Decor::Daisy::Tables::DataTable.new(size: :md)
    rendered = render_component(component)
    refute_includes rendered, "table-md"
  end

  test "supports zebra striping" do
    component = Decor::Daisy::Tables::DataTable.new(zebra: true)
    rendered = render_component(component)
  ...
  test "supports pinned rows" do
    component = Decor::Daisy::Tables::DataTable.new(pin_rows: true)
    rendered = render_component(component)
  ...
  test "supports pinned columns" do
    component = Decor::Daisy::Tables::DataTable.new(pin_cols: true)
    rendered = render_component(component)
  ...
  test "supports title and subtitle with daisyUI colors" do
    component = Decor::Daisy::Tables::DataTable.new(title: "Test Table", subtitle: "Test Subtitle")
    rendered = render_component(component)
  ...
  test "supports style system with daisyUI colors" do
    component = Decor::Daisy::Tables::DataTable.new(style: :bordered)
    rendered = render_component(component)
