...
# Proves the dynamic behaviour of the rich Daisy form widgets in a real browser:
...
class DemoDaisyInputsTest < ApplicationSystemTestCase
  SWITCH = "decor--daisy--forms--switch"
  SS = "decor--daisy--forms--searchable-select"

  test "switch toggles its checkbox" do
    visit demo_daisy_inputs_path
