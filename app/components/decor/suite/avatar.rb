...
module Decor
  module Suite
    # Suite skin of the Avatar component. Single <span> root, hairline border,
    # custom rounded-card for square shape, bespoke gradient palette
    # (:alt1..:alt5) for the placeholder background. Semantic colors fall back
    # to a primary gradient.
