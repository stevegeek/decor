...
module Decor
  module Suite
    module Modals
      # Suite skin of ModalOpenButton — a button that dispatches a window-scoped
      # `decor--suite--modals--modal:open` event so the receiving Modal opens
      # itself with the supplied detail (modal id, optional remote content href,
      # initial body, and title override).
      #
      # Inherits the prop API from Components::Modals::ModalOpenButton (modal_id,
      ...
      class ModalOpenButton < ::Decor::Components::Modals::ModalOpenButton
        ...
        def root_element_classes
          [
            ...
            "decor:font-medium decor:whitespace-nowrap",
