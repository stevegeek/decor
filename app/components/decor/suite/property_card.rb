...
module Decor
  module Suite
    # Suite PropertyCard — card-shaped grouping of label/value pairs with a
    # 2px accent edge on the left, suite-hairline border on the other three
    # sides, suite-section-title heading and optional right-aligned CTA.
    # The body lays the properties out in either a 2/3/4 column grid or a
    # vertical stack of `:row` properties.
