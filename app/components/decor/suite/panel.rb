...
module Decor
  module Suite
    # Suite Panel — titled content section sitting inside a Page (between Page
    # and Card in surface weight). White surface, suite-hairline border,
    # rounded-suite-card corners. Header row uses suite-section-title token
    # with optional left icon; body uses suite-description.
