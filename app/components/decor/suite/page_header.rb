...
module Decor
  module Suite
    # Suite PageHeader — quiet, hairline-bordered page-title bar.
    # Visual identity:
    #   - white surface with bottom suite-hairline divider
    #   - suite-section-pad vertical/horizontal rhythm
    #   - suite-section-title for the title; suite-description for
    #     subtitle/description; suite-gray-25 hero/compact accents
    # Inherits the full slot API from Decor::Components::PageHeader
    # (avatar, title_content, meta_content, actions, secondary_actions,
    #  breadcrumbs, status, cta, badges, tags). The :hero layout in the
    # base is intentionally demoted to a quiet centered surface here —
    # Suite doesn't do gradient hero bars.
