...
module Decor
  module Suite
    # Suite skin of LoadingBar. Thin horizontal progress indicator with
    # gray-200 track and Suite-colored fill. Supports a determinate fill
    # (with optional animated hatch overlay and percentage text) and an
    # indeterminate sliding segment for unknown-duration work.
