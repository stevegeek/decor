...
module Decor
  module Suite
    # Suite skin of Spinner. Renders the historical ConfinusUI border-rotate
    # ring: a circular border with one rotating colored segment via
    # `animate-spin` + `border-t-*`. Reference: ConfinusUI::Spinner (border
    # variant).
