...
module Decor
  module Suite
    module Tables
      # Suite skin of DataTableHeaderCell. Renders a `<th>` with Suite caption
      # typography (uppercase, gray-500, tracked) — distinct from the body
      # cell's suite-body type. Sort icon is a unicode arrow tucked to the
      # right of the title, fading in on hover for sortable columns.
