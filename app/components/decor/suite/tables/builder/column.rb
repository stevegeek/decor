...
module Decor
  module Suite
    module Tables
      module Builder
        # Pure-Ruby data carrier describing a single column in the Suite
        # DataTable builder DSL. Holds the cell-rendering block plus the header
        # / layout / interaction settings shared by every cell in the column.
        #
        # Notes on the port:
        ...
        class Column < ::Literal::Struct
          ...
          # Optional CSS classes applied to all cells in the column.
