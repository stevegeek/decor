...
module Decor
  module Daisy
    # PageHeader A flexible page header component for displaying page titles and
    # metadata. Supports various layouts, backgrounds, and content slots for
    # breadcrumbs, avatars, actions, and custom content areas.
