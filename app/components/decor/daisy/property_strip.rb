...
module Decor
  module Daisy
    # PropertyStrip renders an inline horizontal strip of label/value pairs
    # in a responsive auto-fit grid. Useful for record summaries, header
    # metadata blocks, and dense admin views.
