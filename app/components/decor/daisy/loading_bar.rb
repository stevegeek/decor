...
module Decor
  module Daisy
    # Daisy skin of LoadingBar. Uses daisyUI semantic colors and renders a
    # native `<progress class="d-progress">` for the determinate variant, or
    # a custom animated bar for the indeterminate variant.
