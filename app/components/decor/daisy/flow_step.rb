...
module Decor
  module Daisy
    # FlowStep displays a single step in a sequential process: features icons
    # or numbers, titles, descriptions, and custom content. Commonly used for
    # multi-step forms, onboarding flows, and process indicators.
