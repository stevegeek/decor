...
module Decor
  module Daisy
    # PropertyList renders one or more sections of label/value pairs in a
    # bordered card surface with an optional title and CTA row. Useful for
    # show-page detail blocks and admin record summaries.
