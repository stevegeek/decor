...
module Decor
  module Daisy
    module Nav
      # Breadcrumbs A linear navigation trail that renders as a daisyUI
      # breadcrumbs list with a sibling mobile-select fallback. Accepts a
      # mix of Hash, Breadcrumb value-objects, and duck-typed legacy objects.
