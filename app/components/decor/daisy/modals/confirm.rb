...
module Decor
  module Daisy
    module Modals
      # Daisy skin of Modals::Confirm. Composes Daisy::Modals::Modal with a
      # Cancel/Confirm button pair rendered beside the dialog (Daisy's modal
      # primitive does not own a footer slot).
