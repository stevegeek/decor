...
module Decor
  module Components
    module Nav
      # Abstract base for SideNavbarItem. Owns the prop API + stimulus block
      # plus the slot helper (with_sub_item) and resolve_selected? predicate
      # that keys the stimulus value lookup.
