...
module Decor
  module Components
    module Forms
      # Abstract base for FormChild — the common ancestor of FormFieldLayout
      # and FormField. Owns the prop API + label-position predicates +
      # grid-span helpers. Defines no `view_template`; concrete subclasses
      # (FormFieldLayout, FormField and their concrete skins) supply that.
