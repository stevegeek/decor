...
module Decor
  module Components
    module Forms
      # Abstract base for FormField. Defines no `view_template` — concrete
      # input subclasses (TextField, Select, Checkbox, Radio, Switch, ...)
      # supply that. Owns the full form-field prop API plus the skin-agnostic
      # helpers (validation messages, error text, control data attributes,
      # form-field-layout options, stimulus root-component setup).
      #
      # Concrete skin classes (Decor::Daisy::Forms::FormField and friends)
      # add the Daisy-specific class-string builders.
