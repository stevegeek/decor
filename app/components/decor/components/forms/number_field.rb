...
module Decor
  module Components
    module Forms
      # Abstract base for NumberField. Inherits from TextField (gets the full
      # text-field prop API + add-on slots), narrowing the prop defaults for
      # numeric input. Concrete skins (Daisy, Suite) inherit and supply the
      # view_template via a shared TextFieldTemplate module — NumberField has
      # no view_template of its own.
