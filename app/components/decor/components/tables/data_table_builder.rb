...
module Decor
  module Components
    module Tables
      # Abstract base for DataTableBuilder. Owns all prop declarations + the
      # data preparation pipeline. Concrete skins (Daisy, Suite) inherit and
      # provide `view_template` + the `component` factory that builds the
      # skin-specific DataTable instance.
      class DataTableBuilder < ::Decor::PhlexComponent
