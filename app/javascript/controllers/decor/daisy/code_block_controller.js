...
// A top-level static import compiles to a dynamic `require()` call when a
// consuming esbuild IIFE build marks `@highlightjs/cdn-assets` as external —
// and dynamic require is unsupported in browsers, which throws and halts
// subsequent JS execution.
